                            ...
                            <div class="col-6">
                                <div class="form-check card-radio">
                                    ...
                                    <label class="form-check-label p-0 bg-transparent" for="layout-mode-light">
                                        <img src="build/images/custom-theme/light-mode.png" alt="" class="img-fluid">
                                    </label>
                                </div>
                            ...
                            <div class="col-6">
                                <div class="form-check card-radio dark">
                                    ...
                                    <label class="form-check-label p-0 bg-transparent" for="layout-mode-dark">
                                        <img src="build/images/custom-theme/dark-mode.png" alt="" class="img-fluid">
                                    </label>
                                </div>
                            ...
                            <div class="col-6">
                                <div class="form-check card-radio brand">
                                    ...
                                    <label class="form-check-label cursor-none p-0 bg-transparent opacity-75" for="layout-mode-brand">
                                        <img src="build/images/custom-theme/brand-mode.png" alt="" class="img-fluid">
                                    </label>
                                </div>
    ...
    <script src="{{asset('assets-dashboard/libs/toastify-js/src/toastify.js') }}"></script>
    ...
    <script src="{{asset('assets-dashboard/libs/echarts/echarts.min.js') }}"></script>
    ...
    <script src="{{asset('assets-dashboard/libs/list.js/list.min.js') }}"></script>  
    ...
    <script src="{{ asset('assets-dashboard/js/pages/dashboard-analytics.init.js') }}"></script>
