...
(function () {
            ...
            switch (lang) {
                case "en":
                    document.getElementById("header-lang-img").src =
                        "assets-dashboard/images/flags/us.svg";
                    break;
                case "sp":
                    document.getElementById("header-lang-img").src =
                        "assets-dashboard/images/flags/spain.svg";
                    break;
                case "gr":
                    document.getElementById("header-lang-img").src =
                        "assets-dashboard/images/flags/germany.svg";
                    break;
                case "it":
                    document.getElementById("header-lang-img").src =
                        "assets-dashboard/images/flags/italy.svg";
                    break;
                case "ru":
                    document.getElementById("header-lang-img").src =
                        "assets-dashboard/images/flags/russia.svg";
                    break;
                case "ch":
                    document.getElementById("header-lang-img").src =
                        "assets-dashboard/images/flags/china.svg";
                    break;
                case "fr":
                    document.getElementById("header-lang-img").src =
                        "assets-dashboard/images/flags/french.svg";
                    break;
                case "ar":
                    document.getElementById("header-lang-img").src =
                        "assets-dashboard/images/flags/ae.svg";
                    break;
                default:
    ...
    function twoColumnMenuGenerate() {
        ...
        if (
            ...
            ul.innerHTML =
                '<a href="index" class="logo"><img src="assets-dashboard/images/logo-sm.png" alt="" height="22"></a>';
            Array.from(
                document
                ...
                if (inputLength > 0) {
                    ...
                    Array.from(notifyItem).forEach(function (element) {
                        ...
                        Array.from(
                            ...
                            if (
                                element.querySelectorAll(".notify-item.d-block")
                                    .length == 0
                            ) {
    ...
    function isCustomDropdownResponsive() {
        //Search bar
        var searchOptions = document.getElementById("search-close-options");
        var dropdownResponsive = document.getElementById(
    ...
    function menuPosSetOnClicknHover() {
        const isElement = document.querySelectorAll(
                    ...
                    .addEventListener("click", function (event) {
                        ...
                        document
                            ...
                            .forEach(function (elem) {
                                elem.querySelectorAll(".product-count").forEach(
                                    function (subelem) {
                                        subelem.innerHTML =
    ...
    function updateHorizontalMenus() {
        ...
        const menuData = document.querySelectorAll(
            ...
            if (index + 1 === menuData.length) {
                if (splitItem.insertAdjacentHTML) {
                    splitItem.insertAdjacentHTML(
						...
						<div class="collapse menu-dropdown dropdown-custom-right" id="sidebarMore"><ul class="nav nav-sm flex-column">' +
                            newMenus +
                            "</ul></div>\
					</li>"
                    );
            ...
            x.addEventListener("change", function () {
                ...
                if (ele === "data-bs-theme") {
                    const colorButton =
                        x.value === "light"
                            ? document
                                  .getElementById("topbar-color-light")
                                  ?.click()
                            : document
                                  .getElementById("topbar-color-dark")
                                  ?.click();
                    window.dispatchEvent(new Event("resize"));
                }
    ...
    function setDefaultAttribute() {
        if (!sessionStorage.getItem("defaultAttribute")) {
            ...
            attributesToRetrieve.forEach(function (attribute) {
                isLayoutAttributes[attribute] =
                    sessionStorage.getItem(attribute);
            });
            layoutSwitch(isLayoutAttributes);
        }
    }
    ...
    function setLayoutMode(mode, modeType, modeTypeId, html) {
        ...
        if (isModeTypeId) {
            ...
            if (modeType == "light") modeType = "dark";
    ...
    function initModeSetting() {
        ...
        const lightDarkModeItems = document.querySelectorAll(
            "#light-dark-mode .dropdown-item"
        );
        ...
        lightDarkModeItems.forEach((item) => {
            item.addEventListener("click", (event) => {
                ...
                if (html.hasAttribute("data-bs-theme") && mode !== "auto") {
                    ...
                    const modeValue = prefersDarkScheme.matches
                        ? "dark"
                        : "light";
    ...
    function setResize() {
        ...
        if (currentLayout !== "horizontal") {
            ...
            const twocolumnIconView = document.querySelector(
                ".twocolumn-iconview"
            );
